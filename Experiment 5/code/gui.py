...
bfs_button.place(x=60, y=370)
bfs_button.select()
# dfs: 2
dfs_button = Radiobutton(root, text="Depth First Search", variable=var, value=2)
dfs_button.place(x=235, y=370)
# iddfs: 3
iddfs_button = Radiobutton(root, text="Iterative Deepening Depth First Search", variable=var, value=3)
iddfs_button.place(x=405, y=370)
# best-first: 4
best_button = Radiobutton(root, text="Best First Search", variable=var, value=4)
best_button.place(x=60, y=410)
# bidir: 5
bidir_button = Radiobutton(root, text="Bidirectional Search", variable=var, value=5)
bidir_button.place(x=235, y=410)
# a*: 6
astar_button = Radiobutton(root, text="A* Search", variable=var, value=6)
astar_button.place(x=405, y=410)
# ida*: 7
idastar_button = Radiobutton(root, text="Iterative Deepening A* Search", variable=var, value=7)
idastar_button.place(x=525, y=410)


# result output
# win.create_rectangle(300, 500, 525, 660, width=4)
output = ScrolledText(root, width=30, height=10, bg="Gray", wrap=WORD)
output.place(x=300, y=500)
...
solve_button.place(x=365, y=450)
